package com.example.capstonchatting.chat;
...
import com.example.capstonchatting.model.ChatModel;
import com.example.capstonchatting.model.NotificationModel;
        ...
        void getMessageList() {
            ...
            valueEventListener = databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (!comments.get(comments.size() - 1).readUsers.containsKey(uid)) {                        FirebaseDatabase.getInstance().getReference().child("chatrooms").child(chatRoomUid).child("comments")
